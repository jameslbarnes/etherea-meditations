...
export const sessionData: SessionData = {
  james: {
    ...
    months: {
      ...
      march2025: {
        intention: "James intends to focus on seeing reality more clearly ('asto' - moving away from untruth). He wants to recognize when opportunities would be bad for him in the long run and have the patience not to pursue them impulsively. He aims to find peace in stillness rather than constantly seeking peak experiences, while continuing to produce 'magic' in his life.",
  ...
  andrew: {
    ...
    months: {
      ...
      march2025: {
        intention: "Andrew wants to find newer and different communities focused on wellness, meditation, and sobriety. He aims to make significant money (saving $1 million in 5 years) while maintaining his well-being. He's committed to monogamous dating after realizing non-monogamy didn't resolve his restlessness. Andrew seeks love while maintaining the stillness and presence he cultivated during his time away, though he acknowledges he might be overindexing on wanting/needing love after his recent breakup.",
  ...
  max: {
    ...
    months: {
      ...
      march2025: {
        intention: "Max wants to create a more sustainable balance between work, self-care, and relationships. He aims to carve out dedicated time in the mornings to work out and evenings to read, cook, and spend time with friends. He wants to shorten the margin between the three cornerstones of his life (self-care, work, and relationships) to create a more balanced and sustainable lifestyle while maintaining his professional momentum.",
  ...
  mike: {
    ...
    months: {
      ...
      march2025: {
        intention: "Mike wants to show up with presence for the transitions ahead, especially as he prepares to leave for a Zen Mountain Monastery where he'll participate in intense meditation retreats. He intends to embrace the structure of monastery life (\"the warm hug of death of the schedule\") while continuing his meditation teaching work. He aims to maintain patience with his father, with whom he's developing a deeper connection as he sees and holds space for his father's \"little boy\" and associated fears and anxieties.",
  ...
  seth: {
    ...
    months: {
      february2025: {
        experience: "Seth has been navigating the aftermath of a manic episode that occurred at the end of January. He's been observing his different perspectives in various mental states and working to reconcile them to find what's true. He finds the blind spots he has when completely sober particularly concerning. Seth is preparing for a trip to India in three weeks, which he agreed to during his manic state but isn't currently excited about. He recently returned from a family ski trip in Colorado, where he reconnected with his father and brother, with whom his relationship has improved."
      },
      march2025: {
        intention: "Seth wants to do things for himself, specifically getting back into yoga to prepare for his upcoming retreat in India and taking Zouk dance classes. He also aims to cut back on cannabis use, particularly while traveling. Seth is trying to be more open-minded in dating, exploring connections with people he might not have considered before. His overall goal is to follow through on commitments to himself and explore activities that bring him fulfillment beyond his normal routines.",
  ...
  david: {
    ...
    months: {
      february2025: {
        experience: "David spent the entire month traveling with his partner Andrea, leaving him feeling somewhat burnt out both physically and mentally. His company was acquired after a year of discussions, and while he was well-received by the new ownership, he learned many of his colleagues will be let go. He's feeling pressure to deliver results in a challenging market (carbon project development in the forestry space). Despite the work stress, his relationship with Andrea is progressing well - she met his various parents during their travels, and they're looking forward to establishing a home base in New York."
      },
      march2025: {
        intention: "David aims to find more stillness and mental grounding as he prepares for spring and beyond. He wants to be intentional about any sacrifices he makes for work, potentially being less social temporarily to make time for work and other hobbies. He's processing concerns about American political identity and seeking ways to be more intentionally giving back on a daily basis, particularly as his partner Andrea (who is Mexican) faces immigration uncertainty in the current political climate.",
  ...
  justin: {
    ...
    months: {
      ...
      march2025: {
        intention: "Justin wants to find pleasure and fulfillment in being of service to himself, having recognized that he finds activities like cooking much more gratifying when done for others than for himself alone. He's seeking a passion project that genuinely excites him and learning to enjoy his accomplishments even when they're just for himself. Justin aims to find the same joy in self-care that he experiences when caring for others.",
